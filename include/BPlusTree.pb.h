...
namespace protobuf {
template <>
::BPlusTreeNodeS* Arena::CreateMaybeMessage<::BPlusTreeNodeS>(Arena*);
template <>
::BPlusTreeS* Arena::CreateMaybeMessage<::BPlusTreeS>(Arena*);
template <>
::InternalNodeS* Arena::CreateMaybeMessage<::InternalNodeS>(Arena*);
template <>
::LeafNodeS* Arena::CreateMaybeMessage<::LeafNodeS>(Arena*);
}  // namespace protobuf
}  // namespace google
...
class BPlusTreeS
    : public ::google::protobuf::
          Message /* @@protoc_insertion_point(class_definition:BPlusTreeS) */ {
 public:
  BPlusTreeS();
  virtual ~BPlusTreeS();
...
#if LANG_CXX11
  BPlusTreeS(BPlusTreeS&& from) noexcept : BPlusTreeS() {
    *this = ::std::move(from);
  }
  ...
  static inline const BPlusTreeS* internal_default_instance() {
    return reinterpret_cast<const BPlusTreeS*>(&_BPlusTreeS_default_instance_);
  }
  static constexpr int kIndexInFileMessages = 0;

  void Swap(BPlusTreeS* other);
  friend void swap(BPlusTreeS& a, BPlusTreeS& b) { a.Swap(&b); }
                                                           ...
                                                           */
{
 public:
...
#if LANG_CXX11
  BPlusTreeNodeS(BPlusTreeNodeS&& from) noexcept : BPlusTreeNodeS() {
    *this = ::std::move(from);
  }
  ...
  friend void swap(BPlusTreeNodeS& a, BPlusTreeNodeS& b) { a.Swap(&b); }
                                                          ...
                                                          */
{
 public:
...
#if LANG_CXX11
  InternalNodeS(InternalNodeS&& from) noexcept : InternalNodeS() {
    *this = ::std::move(from);
  }
  ...
  friend void swap(InternalNodeS& a, InternalNodeS& b) { a.Swap(&b); }
 ...
 public:
  ...
  const ::google::protobuf::RepeatedField<::google::protobuf::int32>& keys()
      const;
  ::google::protobuf::RepeatedField<::google::protobuf::int32>* mutable_keys();
  ...
  ::google::protobuf::RepeatedPtrField<::BPlusTreeNodeS>* mutable_children();
  const ::BPlusTreeNodeS& children(int index) const;
  ::BPlusTreeNodeS* add_children();
  const ::google::protobuf::RepeatedPtrField<::BPlusTreeNodeS>& children()
      const;
...
class LeafNodeS
    : public ::google::protobuf::
          Message /* @@protoc_insertion_point(class_definition:LeafNodeS) */ {
 public:
  LeafNodeS();
  virtual ~LeafNodeS();
...
#if LANG_CXX11
  LeafNodeS(LeafNodeS&& from) noexcept : LeafNodeS() {
    *this = ::std::move(from);
  }
  ...
  static inline const LeafNodeS* internal_default_instance() {
    return reinterpret_cast<const LeafNodeS*>(&_LeafNodeS_default_instance_);
  }
  static constexpr int kIndexInFileMessages = 3;

  void Swap(LeafNodeS* other);
  friend void swap(LeafNodeS& a, LeafNodeS& b) { a.Swap(&b); }
...
inline const ::BPlusTreeNodeS& BPlusTreeS::root() const {
  ...
  return p != NULL ? *p
                   : *reinterpret_cast<const ::BPlusTreeNodeS*>(
                         &::_BPlusTreeNodeS_default_instance_);
}
...
inline void BPlusTreeS::set_allocated_root(::BPlusTreeNodeS* root) {
  ...
  if (root) {
    ...
    if (message_arena != submessage_arena) {
      root = ::google::protobuf::internal::GetOwnedMessage(message_arena, root,
                                                           submessage_arena);
    }
...
// int32 MAX_KEYS = 2;
inline void BPlusTreeS::clear_max_keys() { max_keys_ = 0; }
...
// int32 MIN_KEYS = 3;
inline void BPlusTreeS::clear_min_keys() { min_keys_ = 0; }
...
inline const ::LeafNodeS& BPlusTreeS::start() const {
  ...
  return p != NULL ? *p
                   : *reinterpret_cast<const ::LeafNodeS*>(
...
inline void BPlusTreeNodeS::set_has_leaf_node() { _oneof_case_[0] = kLeafNode; }
...
inline ::LeafNodeS* BPlusTreeNodeS::mutable_leaf_node() {
  if (!has_leaf_node()) {
    ...
    set_has_leaf_node();
    node_type_.leaf_node_ =
        CreateMaybeMessage<::LeafNodeS>(GetArenaNoVirtual());
  }
...
inline const ::InternalNodeS& BPlusTreeNodeS::internal_node() const {
  ...
  return has_internal_node() ? *node_type_.internal_node_
                             : *reinterpret_cast<::InternalNodeS*>(
                                   &::_InternalNodeS_default_instance_);
}
inline ::InternalNodeS* BPlusTreeNodeS::mutable_internal_node() {
  if (!has_internal_node()) {
    ...
    node_type_.internal_node_ =
        CreateMaybeMessage<::InternalNodeS>(GetArenaNoVirtual());
  }
...
// repeated int32 keys = 1;
inline int InternalNodeS::keys_size() const { return keys_.size(); }
inline void InternalNodeS::clear_keys() { keys_.Clear(); }
inline ::google::protobuf::int32 InternalNodeS::keys(int index) const {
  // @@protoc_insertion_point(field_get:InternalNodeS.keys)
  return keys_.Get(index);
}
inline void InternalNodeS::set_keys(int index,
...
// repeated .BPlusTreeNodeS children = 2;
inline int InternalNodeS::children_size() const { return children_.size(); }
inline void InternalNodeS::clear_children() { children_.Clear(); }
...
// repeated int32 keys = 1;
inline int LeafNodeS::keys_size() const { return keys_.size(); }
inline void LeafNodeS::clear_keys() { keys_.Clear(); }
...
// repeated uint64 values = 2;
inline int LeafNodeS::values_size() const { return values_.size(); }
inline void LeafNodeS::clear_values() { values_.Clear(); }
...
inline const ::LeafNodeS& LeafNodeS::_internal_next() const { return *next_; }
...
inline void LeafNodeS::set_allocated_next(::LeafNodeS* next) {
  ...
  if (next) {
    ::google::protobuf::Arena* submessage_arena = NULL;
    if (message_arena != submessage_arena) {
      next = ::google::protobuf::internal::GetOwnedMessage(message_arena, next,
                                                           submessage_arena);
    }
